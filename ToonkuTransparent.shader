Shader "Laku/ToonkuTransparent" {
    Properties {
		...
		[Space]
		_DiffShadeAddVal("Diffuse Add shade value", range(0,1)) = 0.5
		_DiffShadeAddStart("Diffuse Add shade start", range(-1,1)) = 0.0
		_DiffShadeAddEnd("Diffuse Add shade end", range(-1,1)) = 0.2
